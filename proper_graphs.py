...
eg1 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 72, nrows = 15, usecols = 'H:AM')
em1 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 92, nrows = 15, usecols = 'H:AM')
eg2 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 168, nrows = 15, usecols = 'H:AM')
em2 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 188, nrows = 15, usecols = 'H:AM')
eg3 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 263, nrows = 15, usecols = 'H:AM')
em3 = pd.read_excel('Graph Data/TEP - Graphs III.xlsx', sheet_name = 'ALL PLOTS', skiprows = 283, nrows = 15, usecols = 'H:AM')
...
def em_plot1(ds, hist):
	...
	plt.stackplot(year, coal, coalccs, gasct, gascc, solarpv, solarcsp, windon, windoff, nuc, geo, bio, hydro, other,\
		...
		'#ff7b00', '#8ead47', '#2b46b1', '#bebebe'])
	plt.xlabel('Year', fontsize = 18)
	plt.ylabel('Total Annual Emissions (MMt CO2e)', fontsize = 18)
